...
public:
   Peer2PeerBackend(GGPOSessionCallbacks *cb, const char *gamename, SOCKET socket, int num_players, int input_size);
...
protected:
   ...
   void AddRemotePlayer(sockaddr_in addr, int queue);
   GGPOErrorCode AddSpectator(sockaddr_in addr);
